...
export default function MobileFilterSection({
  ...
  return (
    <>
      {
        <div
          className={`fixed left-0 z-10 h-dvh w-full overflow-y-scroll bg-stone-50 px-3 py-3 shadow duration-300 md:hidden ${isFilterSectionOpen ? "bottom-0" : "-bottom-full"}`}
        >
